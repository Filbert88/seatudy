...
const CreateCourse = () => {
  ...
  const handleSubmit = async () => {
    ...
    // return;
    if (!courseTitle || !courseDescription || !courseDifficulty || !coursePrice) {
    ...
    try {
      ...
      f.append('categoryNames', JSON.stringify(["Programming", "Web Development"]));
          ...
          <div className="bg-secondary rounded-md p-5 my-5 min-w-[50rem]">
            <form className="form-content items-center justify-center">
              ...
              <div className="flex flex-row items-center mb-5">
                ...
                <select className="bg-white text-black rounded-md ml-5 px-2 py-1" onChange={(e) => setCourseDifficulty(e.target.value)}>
              ...
              <label className="text-white border-2 border-dashed py-10 rounded-md flex flex-col items-center w-80">
                ...
                <input type="file" className="hidden" onChange={handleFileChange} placeholder="Select a thumbnail file" />
              </label>
